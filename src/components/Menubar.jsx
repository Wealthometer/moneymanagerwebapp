    ...
    <div className="flex items-center justify-between gap-5 bg-white border border-b border-gray-200/50 backdrop-blur-[2px] py-4 px-4 sm:px-7 sticky top-0 z-30">
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center justify-center w-10 h-10 bg-gray-100 hover:bg-gray-2 00 rounded-full transition-colors duratio-200 focus:outline-none focus:ring-2 focus:ring-purple-800 focus:ring-offset-2"
        >
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-400 py-1 z-50">
            ...
            <div className="py-1">
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 duration-200"
              >
